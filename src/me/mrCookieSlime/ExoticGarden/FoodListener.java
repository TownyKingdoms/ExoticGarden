...
public class FoodListener implements Listener {
	...
	public void onPlace(BlockPlaceEvent e) {
		...
		if (item != null && (item instanceof EGPlant) && e.getItemInHand().getType() == Material.LEGACY_SKULL_ITEM) e.setCancelled(true);
	}
	...
	public void onEquip(InventoryClickEvent e) {
		...
		if (item != null && (item instanceof EGPlant) && e.getCursor().getType() == Material.LEGACY_SKULL_ITEM) e.setCancelled(true);
	}
