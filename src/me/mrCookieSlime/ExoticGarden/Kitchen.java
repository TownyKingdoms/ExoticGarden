...
public class Kitchen {
	...
	public static final RecipeType KITCHEN = new RecipeType(new CustomItem(Material.LEGACY_CAULDRON_ITEM, "&eKitchen", 0, new String[] {"", "&a&oThis item should be made", "&a&oin the kitchen"}), "KITCHEN");
	...
	public static void registerKitchen(ExoticGarden plugin) {
		...
		new ItemStack[] {new CustomItem(Material.BRICK_STAIRS, "&oBrick Stairs (upside down)", 1), new CustomItem(Material.BRICK_STAIRS, "&oBrick Stairs (upside down)", 1), new ItemStack(Material.BRICK), new ItemStack(Material.LEGACY_STONE_PLATE), new ItemStack(Material.IRON_TRAPDOOR), new ItemStack(Material.BOOKSHELF), new ItemStack(Material.FURNACE), new ItemStack(Material.DISPENSER), new ItemStack(Material.LEGACY_WORKBENCH)},
