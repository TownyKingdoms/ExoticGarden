...
public class ExoticGarden extends JavaPlugin {
	...
	public static ItemStack KITCHEN = new CustomItem(Material.LEGACY_CAULDRON_ITEM, "&eKitchen", 0, new String[] {"", "&a&oYou can make a bunch of different yummies here"});
	...
	public void onEnable() {
		...
		if (loader.load()) {
			...
			category_main = new Category(new CustomItem(getSkull(Material.LEGACY_NETHER_STALK, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTVhNWM0YTBhMTZkYWJjOWIxZWM3MmZjODNlMjNhYzE1ZDAxOTdkZTYxYjEzOGJhYmNhN2M4YTI5YzgyMCJ9fX0="), "&aExotic Garden - Plants and Fruits", "", "&a> Click to open"));
			...
			registerPlant("Lettuce", "&2", Material.LEGACY_LEAVES, PlantType.FRUIT, new PlantData("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDc3ZGQ4NDJjOTc1ZDhmYjAzYjFhZGQ2NmRiODM3N2ExOGJhOTg3MDUyMTYxZjIyNTkxZTZhNGVkZTdmNSJ9fX0="));
			registerPlant("Tea Leaf", "&a", Material.LEGACY_LEAVES, PlantType.DOUBLE_PLANT, new PlantData("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTUxNGM4YjQ2MTI0N2FiMTdmZTM2MDZlNmUyZjRkMzYzZGNjYWU5ZWQ1YmVkZDAxMmI0OThkN2FlOGViMyJ9fX0="));
			registerPlant("Cabbage", "&2", Material.LEGACY_LEAVES, PlantType.FRUIT, new PlantData("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmNkNmQ2NzMyMGM5MTMxYmU4NWExNjRjZDdjNWZjZjI4OGYyOGMyODE2NTQ3ZGIzMGEzMTg3NDE2YmRjNDViIn19fQ=="));
			registerPlant("Sweet Potato", "&6", Material.LEGACY_LEAVES, PlantType.FRUIT, new PlantData("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvM2ZmNDg1NzhiNjY4NGUxNzk5NDRhYjFiYzc1ZmVjNzVmOGZkNTkyZGZiNDU2ZjZkZWY3NjU3NzEwMWE2NiJ9fX0="));
			...
			registerTree("Coconut", new MaterialData(Material.LEGACY_INK_SACK, (byte) 3), "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNmQyN2RlZDU3Yjk0Y2Y3MTViMDQ4ZWY1MTdhYjNmODViZWY1YTdiZTY5ZjE0YjE1NzNlMTRlN2U0MmUyZTgifX19", "COCONUT", "&6", Color.MAROON, "Coconut Milk", false, Material.SAND);
			...
			registerTree("Lemon", new MaterialData(Material.LEGACY_POTATO_ITEM), "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTU3ZmQ1NmNhMTU5Nzg3NzkzMjRkZjUxOTM1NGI2NjM5YThkOWJjMTE5MmM3YzNkZTkyNWEzMjliYWVmNmMifX19", "LEMON", "&e", Color.YELLOW, "Lemon Juice", true, Material.DIRT, Material.GRASS);
			...
			new ItemStack[] {null, new ItemStack(Material.COAL_ORE), null, new ItemStack(Material.COAL_ORE), new ItemStack(Material.LEGACY_SEEDS), new ItemStack(Material.COAL_ORE), null, new ItemStack(Material.COAL_ORE), null});
			...
			registerMagicalPlant("Lapis", new MaterialData(Material.LEGACY_INK_SACK, (byte) 4).toItemStack(16), "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmFhMGQwZmVhMWFmYWVlMzM0Y2FiNGQyOWQ4Njk2NTJmNTU2M2M2MzUyNTNjMGNiZWQ3OTdlZDNjZjU3ZGUwIn19fQ==",
			...
			new ItemStack[] {null, new ItemStack(Material.LEGACY_QUARTZ_ORE), null, new ItemStack(Material.LEGACY_QUARTZ_ORE), getItem("ENDER_PLANT"), new ItemStack(Material.LEGACY_QUARTZ_ORE), null, new ItemStack(Material.LEGACY_QUARTZ_ORE), null});
			...
			final SlimefunItem crook = new SlimefunItem(Categories.TOOLS, new CustomItem(new MaterialData(Material.LEGACY_WOOD_HOE), "&rCrook", "", "&7+ &b25% &7Sapling Drop Rate"), "CROOK", RecipeType.ENHANCED_CRAFTING_TABLE,
			...
			crook.register(false, new BlockBreakHandler() {
				...
				public boolean onBlockBreak(BlockBreakEvent arg0, ItemStack arg1, int arg2,List<ItemStack> arg3) {
					if (SlimefunManager.isItemSimiliar(arg1, crook.getItem(), true)) {
						...
						if ((arg0.getBlock().getType() == Material.LEGACY_LEAVES || arg0.getBlock().getType() == Material.LEGACY_LEAVES_2) && CSCoreLib.randomizer().nextInt(100) < 25) {
							ItemStack sapling = new MaterialData(Material.LEGACY_SAPLING, (byte) ((arg0.getBlock().getData() % 4) + (arg0.getBlock().getType() == Material.LEGACY_LEAVES_2 ? 4: 0))).toItemStack(1);
							arg3.add(sapling);
						}
						return true;
					}
			...
			new SlimefunItem(category_main, grass_seeds, "GRASS_SEEDS", new RecipeType(new CustomItem(Material.LEGACY_LONG_GRASS, "&7Breaking Grass", 1)),
			new ItemStack[] {null, null, null, null, new CustomItem(Material.LEGACY_LONG_GRASS, 1), null, null, null, null})
			...
			items.put("SEEDS", new ItemStack(Material.LEGACY_SEEDS));
			items.put("PUMPKIN_SEEDS", new ItemStack(Material.PUMPKIN_SEEDS));
			items.put("MELON_SEEDS", new ItemStack(Material.MELON_SEEDS));
			items.put("OAK_SAPLING", new ItemStack(Material.LEGACY_SAPLING));
			items.put("SPRUCE_SAPLING", new CustomItem(Material.LEGACY_SAPLING, 1));
			items.put("BIRCH_SAPLING", new CustomItem(Material.LEGACY_SAPLING, 2));
			items.put("JUNGLE_SAPLING", new CustomItem(Material.LEGACY_SAPLING, 3));
			items.put("ACACIA_SAPLING", new CustomItem(Material.LEGACY_SAPLING, 4));
			items.put("DARK_OAK_SAPLING", new CustomItem(Material.LEGACY_SAPLING, 5));
	...
	private void registerDishes() {
		...
		new CustomFood(category_food, new CustomItem(getSkull(new MaterialData(Material.LEGACY_INK_SACK, (byte) 3), "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODE5Zjk0OGQxNzcxOGFkYWNlNWRkNmUwNTBjNTg2MjI5NjUzZmVmNjQ1ZDcxMTNhYjk0ZDE3YjYzOWNjNDY2In19fQ=="), "&rChocolate Bar", "", "&7&oRestores &b&o" + "1.5" + " &7&oHunger"), "CHOCOLATE_BAR",
		new ItemStack[] {new MaterialData(Material.LEGACY_INK_SACK, (byte) 3).toItemStack(1), SlimefunItems.HEAVY_CREAM, null, null, null, null, null, null, null},
		3)
		.register();

		new CustomFood(category_food, new CustomItem(Material.LEGACY_MUSHROOM_SOUP, "&rPotato Salad", 0, new String[] {"", "&7&oRestores &b&o" + "6.0" + " &7&oHunger"}), "POTATO_SALAD",
		...
		new ItemStack[] {new ItemStack(Material.LEGACY_COOKED_FISH), getItem("MAYO"), new ItemStack(Material.BREAD), null, null, null, null, null, null},
		11)
		.register();

		new CustomFood(category_food, new CustomItem(Material.LEGACY_MUSHROOM_SOUP, "&rEgg Salad", 0, new String[] {"", "&7&oRestores &b&o" + "6.0" + " &7&oHunger"}), "EGG_SALAD",
		new ItemStack[] {new ItemStack(Material.EGG), getItem("MAYO"), new ItemStack(Material.BOWL), null, null, null, null, null, null},
		6)
		.register();

		new CustomFood(category_food, new CustomItem(Material.LEGACY_MUSHROOM_SOUP, "&4Tomato Soup", 0, new String[] {"", "&7&oRestores &b&o" + "5.5" + " &7&oHunger"}), "TOMATO_SOUP",
		new ItemStack[] {new ItemStack(Material.BOWL), getItem("TOMATO"), null, null, null, null, null, null, null},
		5)
		.register();

		new CustomFood(category_food, new CustomItem(Material.LEGACY_MUSHROOM_SOUP, "&cStrawberry Salad", 0, new String[] {"", "&7&oRestores &b&o" + "5.0" + " &7&oHunger"}), "STRAWBERRY_SALAD",
		new ItemStack[] {new ItemStack(Material.BOWL), getItem("STRAWBERRY"), null, null, null, null, null, null, null},
		4)
		.register();

		new CustomFood(category_food, new CustomItem(Material.LEGACY_MUSHROOM_SOUP, "&cGrape Salad", 0, new String[] {"", "&7&oRestores &b&o" + "5.0" + " &7&oHunger"}), "GRAPE_SALAD",
		...
		new CustomFood(category_food, new CustomItem(Material.LEGACY_MUSHROOM_SOUP, "&rCreamed Corn", 0, new String[] {"", "&7&oRestores &b&o" + "4.0" + " &7&oHunger"}), "CREAMED_CORN",
		new ItemStack[] {SlimefunItems.HEAVY_CREAM, getItem("CORN"), new ItemStack(Material.BOWL), null, null, null, null, null, null},
		2)
		.register();
		new CustomFood(category_food, new CustomItem(getSkull(Material.LEGACY_GRILLED_PORK, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTdiYTIyZDVkZjIxZTgyMWE2ZGU0YjhjOWQzNzNhM2FhMTg3ZDhhZTc0ZjI4OGE4MmQyYjYxZjI3MmU1In19fQ=="), "&rBacon", "", "&7&oRestores &b&o" + "1.5" + " &7&oHunger"), "BACON",
		new ItemStack[] {new ItemStack(Material.LEGACY_GRILLED_PORK), null, null, null, null, null, null, null, null},
		3)
		.register();
		...
		new ItemStack[] {new ItemStack(Material.BREAD), new ItemStack(Material.LEGACY_GRILLED_PORK), getItem("TOMATO"), getItem("LETTUCE"), null, null, null, null, null},
		18)
		.register();
		...
		new ItemStack[] {new ItemStack(Material.LEGACY_CARROT_ITEM), SlimefunItems.WHEAT_FLOUR, new ItemStack(Material.SUGAR), new ItemStack(Material.EGG), null, null, null, null, null},
		12)
		.register();
		...
		new ItemStack[] {getItem("CORNMEAL"), new ItemStack(Material.LEGACY_COOKED_FISH), getItem("LETTUCE"), getItem("TOMATO"), getItem("CHEESE"), null, null, null, null},
		18)
		.register();
		...
		new CustomFood(category_food, new CustomItem(getSkull(Material.LEGACY_POTATO_ITEM, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTYzYjhhZWFmMWRmMTE0ODhlZmM5YmQzMDNjMjMzYTg3Y2NiYTNiMzNmN2ZiYTljMmZlY2FlZTk1NjdmMDUzIn19fQ=="), "&rFries", "", "&7&oRestores &b&o" + "6.0" + " &7&oHunger"), "FRIES",
		new ItemStack[] {new ItemStack(Material.LEGACY_POTATO_ITEM), getItem("SALT"), null, null, null, null, null, null, null},
		12)
		.register();

		new CustomFood(category_food, new CustomItem(getSkull(Material.LEGACY_POTATO_ITEM, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTQ5N2IxNDdjZmFlNTIyMDU1OTdmNzJlM2M0ZWY1MjUxMmU5Njc3MDIwZTRiNGZhNzUxMmMzYzZhY2RkOGMxIn19fQ=="), "&rPopcorn", "", "&7&oRestores &b&o" + "4.0" + " &7&oHunger"), "POPCORN",
		...
		new ItemStack[] {getItem("CABBAGE"), new ItemStack(Material.LEGACY_CARROT_ITEM), SlimefunItems.WHEAT_FLOUR, new ItemStack(Material.COOKED_BEEF), getItem("TOMATO"), null, null, null, null},
		16)
		.register();

		new CustomFood(category_food, new CustomItem(getSkull(Material.PUMPKIN_PIE, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzQxOGM2YjBhMjlmYzFmZTc5MWM4OTc3NGQ4MjhmZjYzZDJhOWZhNmM4MzM3M2VmM2FhNDdiZjNlYjc5In19fQ=="), "&rChicken Pot Pie", "", "&7&oRestores &b&o" + "8.5" + " &7&oHunger"), "CHICKEN_POT_PIE",
		new ItemStack[] {new ItemStack(Material.COOKED_CHICKEN), new ItemStack(Material.LEGACY_CARROT_ITEM), SlimefunItems.WHEAT_FLOUR, new ItemStack(Material.LEGACY_POTATO_ITEM), null, null, null, null, null},
		17)
		.register();
		...
		new ItemStack[] {null, null, null, null, new ItemStack(Material.LEGACY_GRILLED_PORK), null, null, new ItemStack(Material.BREAD), null},
		10)
		.register();
		...
		new ItemStack[] {getItem("BACON"), getItem("BBQ_SAUCE"), getItem("BACON"), getItem("BACON"), new ItemStack(Material.LEGACY_GRILLED_PORK), getItem("BACON"), getItem("CORNMEAL"), getItem("CHEESE"), getItem("CORNMEAL")},
		20)
		.register();
		...
		new CustomFood(category_food, new CustomItem(getSkull(Material.LEGACY_NETHER_STALK, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNmQ0ZWQ3YzczYWMyODUzZGZjYWE5Y2E3ODlmYjE4ZGExZDQ3YjE3YWQ2OGIyZGE3NDhkYmQxMWRlMWE0OWVmIn19fQ=="), "&cChocolate Strawberry", "", "&7&oRestores &b&o" + "2.5" + " &7&oHunger"), "CHOCOLATE_STRAWBERRY",
		...
		new ItemStack[] {new ItemStack(Material.BREAD), new ItemStack(Material.LEGACY_GRILLED_PORK), getItem("CHEESE"), null, null, null, null, null, null},
		11)
		.register();
		...
		new CustomFood(category_food, new CustomItem(getSkull(Material.LEGACY_SNOW_BALL, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTUzNjZjYTE3OTc0ODkyZTRmZDRjN2I5YjE4ZmViMTFmMDViYTJlYzQ3YWE1MDM1YzgxYTk1MzNiMjgifX19"), "&rIce Cream", "", "&7&oRestores &b&o" + "8.0" + " &7&oHunger"), "ICE_CREAM",
		new ItemStack[] {getItem("HEAVY_CREAM"), getItem("ICE_CUBE"), new ItemStack(Material.SUGAR), new MaterialData(Material.LEGACY_INK_SACK, (byte) 3).toItemStack(1), getItem("STRAWBERRY"), null, null, null, null},
		16)
		.register();
		...
		new CustomFood(category_food, new CustomItem(getSkull(Material.LEGACY_SNOW_BALL, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTY5MDkxZDI4ODAyMmM3YjBlYjZkM2UzZjQ0YjBmZWE3ZjJjMDY5ZjQ5NzQ5MWExZGNhYjU4N2ViMWQ1NmQ0In19fQ=="), "&rTiramisu", "", "&7&oRestores &b&o" + "8.0" + " &7&oHunger"), "TIRAMISU",
		new ItemStack[] {getItem("HEAVY_CREAM"), new ItemStack(Material.EGG), new ItemStack(Material.SUGAR), new MaterialData(Material.LEGACY_INK_SACK, (byte) 3).toItemStack(1), new ItemStack(Material.EGG), null, null, null, null},
		16)
		.register();
	...
	public void registerTree(String name, MaterialData material, String texture, String fruitName, String color, Color pcolor, String juice, boolean pie, Material... soil) {
		...
		items.put(id + "_SAPLING", new CustomItem(Material.LEGACY_SAPLING, color + name + " Sapling", 0));

		new SlimefunItem(category_main, new CustomItem(Material.LEGACY_SAPLING, color + name + " Sapling", 0), id + "_SAPLING", new RecipeType(new CustomItem(Material.LEGACY_LONG_GRASS, "&7Breaking Grass", 1)),
		new ItemStack[] {null, null, null, null, new CustomItem(Material.LEGACY_LONG_GRASS, 1), null, null, null, null})
		.register();

		try {
			new EGPlant(category_main, new CustomItem(getSkull(material, texture), color + StringUtils.format(fruitName)), fruitName, new RecipeType(new CustomItem(Material.LEGACY_LEAVES, "&7Obtained by harvesting the specific Tree", 0)), true,
	...
	public void registerBerry(String name, String color, Color pcolor, PlantType type, PlantData data) {
		...
		items.put(name.toUpperCase() + "_BUSH", new CustomItem(Material.LEGACY_SAPLING, color + name + " Bush", 0));

		new SlimefunItem(category_main, new CustomItem(Material.LEGACY_SAPLING, color + name + " Bush", 0), name.toUpperCase() + "_BUSH", new RecipeType(new CustomItem(Material.LEGACY_LONG_GRASS, "&7Breaking Grass", 1)),
		new ItemStack[] {null, null, null, null, new CustomItem(Material.LEGACY_LONG_GRASS, 1), null, null, null, null})
		.register();

		new EGPlant(category_main, new CustomItem(getSkull(Material.LEGACY_NETHER_STALK, data.getTexture()), color + name), name.toUpperCase(), new RecipeType(new CustomItem(Material.LEGACY_LEAVES, "&7Obtained by harvesting the specific Bush", 0)), true,
	...
	public void registerPlant(String name, String color, Material material, PlantType type, PlantData data) {
		...
		items.put(name.toUpperCase() + "_BUSH", new CustomItem(Material.LEGACY_SAPLING, color + name + " Plant", 0));

		new SlimefunItem(category_main, new CustomItem(Material.LEGACY_SAPLING, color + name + " Plant", 0), name.toUpperCase().replace(" ", "_") + "_BUSH", new RecipeType(new CustomItem(Material.LEGACY_LONG_GRASS, "&7Breaking Grass", 1)),
		new ItemStack[] {null, null, null, null, new CustomItem(Material.LEGACY_LONG_GRASS, 1), null, null, null, null})
		.register();

		new EGPlant(category_main, new CustomItem(getSkull(material, data.getTexture()), color + name), name.toUpperCase().replace(" ", "_"), new RecipeType(new CustomItem(Material.LEGACY_LEAVES, "&7Obtained by harvesting the specific Bush", 0)), true,
	...
	public void registerMagicalPlant(String name, ItemStack item, String skull, ItemStack[] recipe) {
		...
		new SlimefunItem(category_magic, new CustomItem(Material.LEGACY_SAPLING, "&r" + name + " Plant", 0), name.toUpperCase().replace(" ", "_") + "_PLANT", RecipeType.ENHANCED_CRAFTING_TABLE,
		recipe)
		.register();
					...
					switch (berry.getType()) {
						...
						case DOUBLE_PLANT: {
							...
							if (BlockStorage.check(block.getRelative(BlockFace.DOWN)) == null) {
								...
								block.getWorld().playEffect(block.getRelative(BlockFace.UP).getLocation(), Effect.STEP_SOUND, Material.LEGACY_LEAVES);
								block.getRelative(BlockFace.UP).setType(Material.AIR);;
							}
							else {
								plant = block.getRelative(BlockFace.DOWN);
								BlockStorage.retrieve(block);
								block.getWorld().playEffect(block.getLocation(), Effect.STEP_SOUND, Material.LEGACY_LEAVES);
								block.setType(Material.AIR);;
							}
							plant.setType(Material.LEGACY_SAPLING);
